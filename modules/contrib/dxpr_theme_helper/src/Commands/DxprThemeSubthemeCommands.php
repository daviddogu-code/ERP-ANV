...
/**
 * Drush commands for DXPR Theme subtheme creation.
 *
 * Migrated from DxprThemeHelperCommands to the dxt:* namespace.
 */
class DxprThemeSubthemeCommands extends DxprThemeCommandsBase {

  /**
   * Create a DXPR Theme subtheme.
   */
  #[CLI\Command(name: 'dxt:subtheme:create', aliases: ['dxt-sc', 'dxpr-cs', 'dxpr:create-subtheme'])]
  #[CLI\Help(description: 'Creates a DXPR Theme subtheme from the starterkit.')]
  ...
  #[CLI\Usage(name: 'drush dxt:subtheme:create', description: 'Create a subtheme interactively')]
  #[CLI\Usage(name: 'drush dxt-sc my_theme_name', description: 'Create a subtheme with machine name')]
  #[CLI\Usage(name: 'drush dxt-sc my_theme --theme-name="My Custom Theme"', description: 'Create with custom name')]
