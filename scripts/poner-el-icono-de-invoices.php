...
/**
 * @file
 * Le pone a la portada el icono de Invoices, el libro 036x.
 *
 *   php vendor\bin\drush.php scr scripts/poner-el-icono-de-invoices.php
 *   php vendor\bin\drush.php scr scripts/poner-el-icono-de-invoices.php -- --de-verdad
 *
 * La pantalla vive en /o/inv. Sin el icono en /start solo se llega desde el
 * pedido o escribiendo la URL.
 *
...
const ICONO = 'private://2026-09/isometric-invoices-100.png';
const TITULO = 'Invoices';
const DESTINO = 'internal:/o/inv';
const ORDEN = 19;
const AJUSTE = 'invoices_tile_nid';
