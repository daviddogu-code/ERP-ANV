...
/**
 * @file
 * Le pone a la portada el icono de Shipments, la lista de envios de fabrica.
 *
 *   php vendor\bin\drush.php scr scripts/poner-el-icono-de-shipments.php
 *   php vendor\bin\drush.php scr scripts/poner-el-icono-de-shipments.php -- --de-verdad
 *
 * La pantalla vive en /o/ship. Sin el icono en /start solo se llega desde la
 * ficha del cliente o escribiendo la URL.
 *
...
const ICONO = 'private://2026-09/isometric-shipments-100.png';
const TITULO = 'Shipments';
const DESTINO = 'internal:/o/ship';
const ORDEN = 18;
const AJUSTE = 'shipments_tile_nid';
